...
export default function StatTriplet() {
  return (
    <section className="relative border-t border-line py-14 sm:py-16">
          ...
          {stats.map((s, i) => (
            ...
            >
              <dt className="flex items-center gap-2 text-[0.7rem] uppercase tracking-[0.2em] text-text-mute">
                <span className="relative inline-flex text-green">
              ...
              <dd className="mt-3">
                <span className="tnum block text-[2.5rem] font-medium leading-none tracking-tight text-text sm:text-[2.75rem]">
                  {s.render}
                </span>
                <p className="mt-3 border-t border-line pt-3 text-[0.82rem] leading-relaxed text-text-dim">
                  {s.note}
                </p>
              </dd>
            </Reveal>
